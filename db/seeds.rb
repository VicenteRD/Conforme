...
pos_audit.parent_id = pos_staff.id
pos_audit.save!

pos_staff.add_to_set(children_ids: pos_audit.id)
pos_staff.save!
...
Settings::PeopleSetting.create!(staff_position_id: pos_staff.id, audit_position_id: pos_audit.id)
